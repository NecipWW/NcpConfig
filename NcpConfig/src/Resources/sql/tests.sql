select *
from ncp_configurator_class;
select *
from ncp_configurator_classcon;
select *
from ncp_configurator_object;
select *
from ncp_configurator_objectcon;
# select * from product;
...
select cls_from_name,
       ...
       pg_dm_value_max
from ncpv_configurator_objcon
where cls_from_name = 'ProjectGroup'
  and cls_to_name = 'Dimension';
