...
values (@objId_ProjectGroup_Balcony, @clsId_ProjectGroup, 'Balcony railings', 'Balcony railings', now(),
        null), -- Balkongeländer
...
values
    ...
    -- window grid
    (@objId_ProjectGroup_windowgrid_to_dimension_Length, @clsconId_ProjectGroup_dimension, '',
     @objId_ProjectGroup_WindowGrid,
     @objId_dimension_Length, 20, 30, now(), null),
    (@objId_ProjectGroup_windowgrid_to_dimension_Height, @clsconId_ProjectGroup_dimension, '',
     @objId_ProjectGroup_WindowGrid,
     @objId_dimension_Height, 30, 40, now(), null),
    (@objId_ProjectGroup_windowgrid_to_dimension_Width, @clsconId_ProjectGroup_dimension, '',
     @objId_ProjectGroup_WindowGrid,
